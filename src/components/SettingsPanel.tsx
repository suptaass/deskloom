...
// Rule: Dumb Component — ไม่ import store, รับทุกอย่างผ่าน props เท่านั้น
...
const SettingsPanel: React.FC<SettingsPanelProps> = ({
  ...
  const [showResetConfirm, setShowResetConfirm] = useState(false); // Step 7-4
  ...
  return (
    <div style={panelStyle}>
      ...
      <div style={{
        ...
        <button
          style={{
            ...baseBtnStyle, width: "30px", height: "30px", padding: 0,
      ...
      <div style={sectionStyle}>
        ...
        <div style={{ display: "flex", gap: "8px" }}>
          <button
            style={{ ...baseBtnStyle, flex: 1, fontSize: "11px" }}
            onClick={() => onAddWidgetInstance("todo")}
          >+ Todo</button>
          <button
            style={{ ...baseBtnStyle, flex: 1, fontSize: "11px" }}
            onClick={() => onAddWidgetInstance("notes")}
          >+ Notes</button>
        </div>
      </div>
      ...
      <div style={{ padding: "16px 18px", flex: 1 }}>
        <p style={sectionTitleStyle}>Widgets</p>
        {widgets.map((widget) => {
          ...
          return (
            <div key={widget.id} style={{
              marginBottom: "12px", padding: "11px 12px",
              borderRadius: "10px", border: "1px solid var(--note-border)",
              background: "var(--input-bg)",
            }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "5px" }}>
                <p style={{ fontSize: "10px", color: "var(--text-secondary)" }}>
                  {WIDGET_TYPE_ICON[widget.type]}
                </p>
                {isDeletable && (
                  <button
                    style={{
                      ...baseBtnStyle, padding: "2px 8px", fontSize: "10px",
                      borderColor: "var(--accent-red-border)", color: "var(--accent-red)",
                    }}
              ...
              <div style={{ display: "flex", gap: "6px", marginBottom: "8px" }}>
                <button
                  style={{
                    ...baseBtnStyle, flex: 1, fontSize: "11px", padding: "4px 0",
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    onSetOpacity(widget.id, parseInt(e.target.value, 10) / 100)
                  }
      ...
      {/* ── Reset Layout (Step 7-4: with confirmation) ───────────────────────── */}
      <div style={{
        padding: "14px 18px",
        ...
        {showResetConfirm ? (
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: "8px" }}>
              <button
                style={{ ...baseBtnStyle, flex: 1, padding: "7px 0", fontSize: "12px" }}
              ...
              <button
                style={{
                  ...baseBtnStyle, flex: 1, padding: "7px 0", fontSize: "12px",
          ...
          <div>
            <button
              style={{
                ...baseBtnStyle, width: "100%", padding: "8px",
                borderColor: "var(--accent-red-border)", color: "var(--accent-red)",
              }}
            ...
            <p style={{ ...subTextStyle, textAlign: "center", marginTop: "6px" }}>
              Resets position and size of all widgets
            </p>
          </div>
        )}
      </div>
